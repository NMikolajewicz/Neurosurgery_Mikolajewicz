...
- `replaceOrgLatex`: If `true` (default), converts Org-mode [[Neurosurgery/00_Neurosurgery_Mikolajewicz/docs/features/Latex|Latex]] fragments to Quartz-compatible LaTeX wrapped in `$` (for inline) and `$$` (for block equations).
