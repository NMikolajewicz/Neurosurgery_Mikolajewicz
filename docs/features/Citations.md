...
Citation parsing is a functionality of the [[Neurosurgery/00_Neurosurgery_Mikolajewicz/docs/plugins/Citations|Citation]] plugin. **This plugin is not enabled by default**. See the plugin page for customization options.
