...
Latex parsing is a functionality of the [[Neurosurgery/00_Neurosurgery_Mikolajewicz/docs/plugins/Latex|Latex]] plugin. See the plugin page for customization options.
