...
A good example of a transformer plugin that borrows from the `remark` and `rehype` ecosystems is the [[Neurosurgery/00_Neurosurgery_Mikolajewicz/docs/plugins/Latex|Latex]] plugin:
