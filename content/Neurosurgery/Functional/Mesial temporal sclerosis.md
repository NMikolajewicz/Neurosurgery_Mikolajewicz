...
![[Neurosurgery/Functional/_resources/Mesial_temporal_sclerosis.resources/image.1.png|500]]

<div class="joplin-table-wrapper"><table width="376px" style="border-collapse:collapse;width:376px;"><colgroup><col style="width: 188px;"><col style="width: 188px;"></colgroup><tbody><tr><td style="border-color:#ccc;border-width:1px;border-style:solid;padding:10px;" colspan="2"><img src="./_resources/Mesial_temporal_sclerosis.resources/image.png" alt="image.png"><div>A: normal hippocampus</div><div>B: hippocampus sclerosis</div><ul><li>loss of neurons (CA1, CA3, CA4)</li><li>CA2 spared</li><li>astrocytic gliosis</li><li>granular cell dispersion</li></ul><div><br></div></td></tr><tr><td style="border-color:#ccc;border-width:1px;border-style:solid;padding:10px;"><img src="./_resources/Mesial_temporal_sclerosis.resources/image.2.png" alt="image.2.png"><div>left-sided hippocampal sclerosis</div></td><td style="border-color:#ccc;border-width:1px;border-style:solid;padding:10px;"><img src="./_resources/Mesial_temporal_sclerosis.resources/image.3.png" alt="image.3.png"><div>small right hippocampus with increased T2 signal</div></td></tr><tr><td style="border-color:#ccc;border-width:1px;border-style:solid;padding:10px;"><img src="./_resources/Mesial_temporal_sclerosis.resources/image.4.png" alt="image.4.png"><div>volume loss in left temporal lobe / hippocampus</div></td><td style="border-color:#ccc;border-width:1px;border-style:solid;padding:10px;"><div><br></div></td></tr></tbody></table></div>
