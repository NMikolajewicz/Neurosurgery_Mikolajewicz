...
* syndrome of multiple etiologies
	* ==small posterior fossa==
		* ==considered underlying cause of cerebellar tonsillar descent==
	* following lumboperitoneal shunt placement
	* craniosynostosis
	* congenital upper cervical spine abnormalities
four names this abnormality has been called. 
* tonsillar **herniation**
...
* typically young adult with neck pain and suboccipital headaches
	...
	* focal arm/leg weakness/numbness
	* gait unsteadiness
	* CN findings
		* aspiration
		* nystagmus from compression of tonsils
* most to least common:
	* hyper-reflexia
	* nystagmus
	* gait disturbance
	* dysmetria
	* upper extremitiy muscle atrophy
	* aspiration
...
* age: younger adults
* presentation
	* non-dermatological pain in occipital/cervical region
	* diminished CSF circulation at craniocervical junction
		* classic tussive or strain-associated headache
* imaging
	* small posterior fossa
	* empty sella
	* platybasia
...
* features
	...
	* pulls on brainstem
	* small posterior fossa
	* downward displacement of brain stem and cerebellum (vermis and inferior poles of hemispheres)
	* hydrocephalus
* complications
	* injury to cerebellum, medulla, lower cranial nerves
	* progressive ataxia, leg weakness, dysphagia, vocal cord paralyis / stridor, apneic spells
	* aspiration; recurrent pneumonia
* indications for expeditious decompression
	* dysphagia
...
| --------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------- |
| **Typical association**           | ==Isolated==; scoliosis, **==syringomyelia==** common                                                                               | **==Myelomeningocele==** (~all), severe ==hindbrain malformation==                                                                |
| **Age/presentation**              | Late childhood → adult; ==**Valsalva occipital headache**==, neck pain, ataxia, cranial nerve symptoms; syrinx sensory dissociation | Neonate/infant; ==**bulbar/brainstem dysfunction**== (apnea, stridor, dysphagia, weak cry), arm weakness; often **hydrocephalus** |
| **Hydrocephalus**                 | Uncommon (unless coexisting lesions)                                                                                                | **==Common==**; often needs shunt/ETV                                                                                             |
| **Syringomyelia**                 | **==Common==** (up to ~50%)                                                                                                         | Possible, but less central than hydrocephalus/brainstem signs                                                                     |
...
* surgery indications
	* syrinx
		...
		* if > 2 mm, operate
		* goal: reduce syrinx size
	* symptomatic
		* valsalva-induced occipital headaches
			* lifestyle limiting
			* refractory to non-surgical management
		* brainstem dysfunction
			* respiratory or CN dysfunction
		* progressive scoliosis
		* goal:
			* alleviate brainstem and cranial nerve compression
			* restore CSF flow at the craniocervical junction
* surgical approach
	* suboccipital craniectomy +/- C1 laminectomy +/- duralplasty/dural-splitting
		* \> 3 cm high/wide from foramen megnum
		* goal is to decompress tonsils
* post-operative
	* if chiari II, respiratory monitoring
		* respiratory arrest is common cause of mortality
	* MRI q6-12 months for syrinx
* in pediatric, check neuraxis MRI
	* HCP
	* tethered cord
* if symptomatic
	* goal: restore normal CSF dynamics across craniocervical junction
* if hydrocephalus
	* resolve prior to considering Chiari decompression
* if Chiari II
	* swallow study
...
* CSF leak
	* management
		* head of bed up
		* suture wound if leak external
		* lumbar drain
		* revision
		* VP shunt
* aseptic meningitis
	* due to irritation from subdural blood
	* management
		* 7-10 days of high-dose steroids
* reclosure of outlet foramen
	* management
		* redo decompression
		* resection of tonsil
* persistent syrinx
