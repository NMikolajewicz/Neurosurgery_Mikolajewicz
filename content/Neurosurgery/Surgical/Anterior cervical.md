---
---
![[Neurosurgery/Surgical/_resources/Anterior_cervical.resources/image.png]]![[Neurosurgery/Surgical/_resources/Anterior_cervical.resources/image.1.png]]

![[Neurosurgery/Surgical/_resources/Anterior_cervical.resources/image.2.png]]
**Figure. Proper fixation points for Gardner-Wells tongs application. (A)** Posterior placement of tongs to produce flexion of head. **(B)** Normal placement of tongs to produce straight traction. **(C)** Anterior placement of tongs to produce hyperextension of head
...
1. Identify landmarks and draw transverse incision.
...
3. Identify the left recurrent laryngeal nerve
...
1. Place caspar pins and distract across disk space.
2. Sharply incise the anterior annulus and remove the ALL
3. Remove disc material until PLL visualized
...
5. Lateralize discectomy

### Decompression of Spinal Cord and Nerve Roots

1. Remove Posterior Longitudinal Ligament
...
1. Select appropriately sized plate
...
3. superficial closure
	* 4-0 monocryl
4. dressing and immediate immobilization
...
* risk reduction strategies:
	* L sided surgical approach
		* more consistent and protected path than on right side
	* minimize endotracheal tube cuff pressure
	* limit retractor time and force
	* dissect along avascular plan
		* avoid deep medial dissection

### horners syndrome

* risk reduction strategy:
	* do not dissect lateral coli too laterally
* sympathetic trunk courses anterior to longus colli fascia, lateral to muscle belly
