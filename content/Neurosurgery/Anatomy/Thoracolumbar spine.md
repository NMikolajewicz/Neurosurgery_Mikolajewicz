---
title: Thoracic & Lumbar Spine Anatomy (T1–L5) for Royal College Neurosurgery Exams
created: 2026-02-20
updated: 2026-02-20
tags:
  - neurosurgery
...
```mermaid
graph TD
V[Vertebral bodies extend beyond spinal cord length in adults] --> M[Spinal cord segments lie relatively higher than corresponding exit foramina]
M --> R[Lumbar + sacral roots elongate and descend within the canal]
R --> CE[Cauda equina forms in lumbar cistern below conus]
CE --> EX[Roots exit at their respective intervertebral foramina]
```
