---
date created: Monday, October 9th 2023, 9:43:38 am
date modified: Thursday, February 12th 2026, 5:20:49 pm
tags:
...
- Also known as: Cervical degenerative disc disease, cervical spondylosis, cervical spinal stenosis
## Epidemiology

- **CSM** is the **most common cause of myelopathy in patients >55 years**; **rare <40 years**
- **Asymptomatic cervical spondylosis is very common**
- **Cord compression on imaging ≠ symptoms**: ~**26%** of asymptomatic individuals **>64** have spinal cord compression (MRI)
...
| -------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------- |
| **Definition**                   | Degenerative cervical canal narrowing → **cord dysfunction** (DCM/CSM)                                                                       |
| **Typical patient**              | **>55** years; uncommon <40                                                                                                                  |
| **Early symptoms**               | **Gait disturbance** ± LE weakness/stiffness (common early)                                                                                  |
| **Pain**                         | **Neck pain/mechanical signs uncommon** in "pure" myelopathy                                                                                 |
| **Common exam signs**            | Hyperreflexia, Babinski; Hoffmann                                                                                                            |
...
- **Normative cervical canal widths** (reference link):
    - [https://pubs.rsna.org/doi/abs/10.1148/radiol.13120370?journalCode=radiology#:~:text=Sagittal%20spinal%20canal%20diameter%20C1,mm%20and%20men%2C%2015.4%20mm](https://pubs.rsna.org/doi/abs/10.1148/radiol.13120370?journalCode=radiology#:~:text=Sagittal%20spinal%20canal%20diameter%20C1,mm%20and%20men%2C%2015.4%20mm)
- Practical stenosis metrics:
    - Average minimal **AP canal diameter ~11.8 mm** in CSM patients
    - AP diameter **≤10 mm**: "likely associated" with myelopathy
    - AP diameter **<14 mm**: increased risk of CSM
    - CSM is **rare if diameter >16 mm**
    - **Pavlov (Torg) ratio** <0.8: sensitive for transient neuropraxia but **poor +predictive value** for CSM
    - X-ray canal diameters are **surrogates**; the real issue is **cord compression** on CT/MRI

> [!exam] Thresholds
> 
> - **AP canal ≤10 mm** → high association with myelopathy
> 
> - **AP canal <14 mm** → increased risk
> 
> - **Cord atrophy**: transverse area **<45 mm²** = poor prognostic sign
>  

## Clinical presentation

- CSM tends to occur when there is substantial canal narrowing (but compression does not always equal myelopathy)
- **Common early pattern**
    - **Gait disturbance** ± LE weakness/stiffness
    - **Ataxia** can reflect spinocerebellar tract involvement
...
- **Radiculopathy clues**
    - Dermatomal sensory loss/pain aligned with weakness distribution
    - **Mechanical signs**: reproduce radicular symptoms with **axial loading** (Spurling-type)
- **Myelopathy clues**
...
- 2. **Motor system syndrome**: corticospinal + anterior horn involvement with minimal sensory deficit; can mimic ALS pattern (LMN UE + UMN LE)
- 3. **Central cord syndrome** phenotype: UE > LE deficits; "numb-clumsy hands"; Lhermitte may be more common
- 4. **Brown-Séquard** phenotype: asymmetric compression → ipsilateral corticospinal/posterior column with contralateral pain/temp loss
...
- Dynamic mechanisms contribute:
    - Canal diameter varies with motion; ==stenosis often worse in extension==
    - Segmental instability may sublux ("pincer mechanism")
    - Traction via dentate ligaments/nerve roots described
- Histopathology:
    - Central gray matter degeneration at compression level
    - Posterior column degeneration above lesion
    - Lateral column/corticospinal demyelination below
    - Relative sparing of anterior spinal tracts
...
![[Neurosurgery/Spine/_resources/Degenerative_cervical_myelopathy.resources/Image 20231009 094947.png|500]]![[Neurosurgery/Spine/_resources/Degenerative_cervical_myelopathy.resources/Image 20231009 095007.png|500]]![[Neurosurgery/Spine/_resources/Degenerative_cervical_myelopathy.resources/Image 20231009 095123.png|500]]
...
- Bone/calcified ligament assessment is limited on MRI → add plain films or CT bone windows

> [!warning] MRI findings associated with poorer outcome
> 
> - **Multilevel T2 hyperintensity**
> 
> - "**Snake eyes / owl's eyes**" on axial T2 (may reflect cystic necrosis)
> 
> - **Single-level T2 hyperintensity + T1 hypointensity**
> 
...
- ALS pitfall: in one ALS series (n≈1500), **4%** underwent spine surgery before ALS diagnosis (most cervical)

> [!warning] Exam pitfall
> 
> - Mixed **LMN UE + UMN LE** patterns can mimic ALS and vice versa (especially the "motor system syndrome")
>  
...
|---|---|---|---|---|
|**Definition**|Chronic myelopathy from degenerative spondylosis/stenosis and cord compression|Myelopathy from **ossified PLL**; often **adherent to dura**|Developmentally narrow canal; degenerative changes may "unmask" myelopathy; often drives posterior-first strategy when canal cannot be widened enough anteriorly|Acute cord dysfunction/SCI from disc herniation (traumatic classically; can be non-traumatic)|
|**Types**|Often multilevel; phenotypes include transverse lesion, motor system, central cord, Brown-Séquard, brachialgia+cord|OPLL can be **segmental or diffuse**|"Narrow canal" phenotype; can coexist with multilevel degeneration; posterior decompression commonly needed when minimum AP target cannot be achieved anteriorly|Can present with incomplete syndromes (notably central cord; sometimes Brown-Séquard)|
|**Symptoms**|Early: gait disturbance ± LE stiffness/weakness; ataxia possible; neck pain/mechanical signs often minimal in pure myelopathy|Similar long-tract symptoms; intrinsic cord abnormalities on T2 may indicate worse outcome|Often earlier/greater vulnerability to symptoms for a given degenerative burden (supplement)|More abrupt neurologic change after trauma or spontaneous event; can resemble central cord syndrome|
|**Epidemiology**|Most common cause of myelopathy in **>55**; rare <40|More prevalent in East Asian populations (supplement); often associated with other ossification disorders (supplement)|Developmental narrowing predisposes; screening by Pavlov ratio sometimes used|Less common cause of myelopathy overall; classically traumatic association, sometimes non-traumatic|
|**Diagnosis**|MRI for canal + intrinsic cord; add CT bone windows/plain films for osteophyte/disc differentiation|Plain films often miss OPLL; MRI: hypointense lesion hard to appreciate until ~**5 mm**; CT-myelogram best with 3D recon|Measure canal; recognize that x-ray metrics are surrogates; decision often based on decompression feasibility (e.g., AP target ~12 mm)|MRI to identify disc/cord compression and intramedullary signal change (supplement)|
