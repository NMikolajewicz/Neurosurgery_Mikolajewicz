---
date created: Monday, September 25th 2023, 10:01:46 pm
date modified: Thursday, February 12th 2026, 1:04:11 pm
tags: [ISNCSCI, ASIA, posterior-cord-syndrome, SCI, conus-medullaris-syndrome, central-cord-syndrome, brown-sequard-syndrome, anterior-cord-syndrome]
---
> [!exam] High-yield summary
> 
> - **ATLS + immobilization**; document baseline **ISNCSCI/ASIA** (confirm **sacral sparing**).
>     
> - Imaging: **CT** for fractures; **MRI** for cord/ligament/disc (STIR sequence).
>     
> - Hemodynamics: avoid **SBP <90**; target **MAP 75–80 to 90–95 mmHg for 3–7 d** (historic: **85–90 x 7 d**).
>     
> - **Early decompression ≤24 h**.
>     
> - Shock: **spinal shock** = transient areflexia; **neurogenic shock** = hypotension + bradycardia (often **≥T6**).
>     
...
- Fehlings/Ahuja et al., _Traumatic spinal cord injury_ (Nature Reviews Disease Primers, 2017).
- Kwon et al., _AO Spine/Praxis CPGs for acute SCI (Focus Issue intro)_ (Global Spine Journal, 2024).
---

## Definitions & Time Course

- **SCI** = spinal cord damage causing temporary/permanent functional change; 
	- **traumatic** vs **non-traumatic** etiologies.
- **tSCI phases (temporal)**

|Phase|Time window|
|---|---|
|**Acute**|**<48 h**|
|**Subacute**|**48 h–14 d**|
|**Intermediate**|**14 d–6 mo**|
|**Chronic**|**>6 mo**|

> [!Time]
> 
> - **"Time is spine"**: progressive loss of functional neural tissue in hours after tSCI → urgency in diagnosis + neuroprotection.
>  

---

## Epidemiology (numbers to memorize)

- Incidence (traumatic SCI, developed regions)
    - North America: 39/million
    - Australia: 16/million
    - Western Europe: 15/million
- Sex: <span style="background:rgba(240, 200, 0, 0.2)">male 79.8%</span>, female 20.2%
- Age (<span style="background:rgba(240, 200, 0, 0.2)">bimodal</span>): peak 15–29 and a growing peak >50
- Mechanism (2010–2014, NA): <span style="background:rgba(240, 200, 0, 0.2)">MVC 38%, falls 31%</span>, sports 10–17%
- Level distribution: <span style="background:rgba(240, 200, 0, 0.2)">cervical ~60%</span>, thoracic 32%, lumbosacral 9%

---

## Mortality & Life Expectancy

- Acute in-hospital mortality: 4–17%
- Post-discharge annual mortality
    - Year 1: 3.8%
    - Year 2: 1.6%
    - Then: 1.2%/year
- Life expectancy example (injured at age 40)
    - C5–C8: 23 years
    - C1–C4: 20 years
    - <span style="background:rgba(240, 200, 0, 0.2)">Ventilator dependent: 8.5 years</span>
...
- Primary injury: 
	- <span style="background:rgba(240, 200, 0, 0.2)">mechanical</span> disruption/compression/transection 
	- <span style="background:rgba(240, 200, 0, 0.2)">vascular</span> injury
	- blood–spinal cord <span style="background:rgba(240, 200, 0, 0.2)">barrier</span> disruption.
- Secondary injury
    - <span style="background:rgba(240, 200, 0, 0.2)">Inflammation</span>: ↑ TNF, IL-1β within minutes; inflammatory cell infiltration persists beyond subacute phase.
    - <span style="background:rgba(240, 200, 0, 0.2)">Excitotoxicity</span>: glutamate → NMDA/AMPA/kainate overactivation → cell death.
    - <span style="background:rgba(240, 200, 0, 0.2)">Oxidative stress</span>: free radicals → lipid/DNA/protein damage.
- Chronic lesion architecture
    - <span style="background:rgba(240, 200, 0, 0.2)">Cystic cavitation</span> (ex vacuo) → barrier to axonal regrowth.
...
- Fracture level ≠ neuro level
	- especially mid–lower thoracic (e.g., T8 fracture → T12 neuro, T12 fracture → S1 neuro).
- <span style="background:rgba(240, 200, 0, 0.2)">Respiratory compromise by level</span>
    - Above C5 → diaphragm innervation risk
    - Above T11 → intercostals risk
    - Above L1 → abdominal muscles risk
- Sympathetic outflow: preganglionic neurons T1–L2
	- high lesions → loss of vascular tone.
...
- Neurogenic shock = distributive shock from loss of sympathetic tone
    ...
    - occurs up to 20% of cervical injuries; bradycardia in nearly all severe cervical injuries (acute phase).

> [!Shock]
> 
> - **Do not conflate**: **spinal shock** (neuro exam unreliability) vs **neurogenic shock** (hemodynamics).
>  
...
- **ATLS + immobilization**
- gross neuro exam includes **limb motor/sensory + rectal exam** when SCI suspected.
### Imaging modalities

- **X-ray**: AP/lateral C-spine + AP chest/pelvis in trauma bay; ensure adequacy to **rostral half of T1**.
- **CT**: supplants X-ray for bony injury; some recommend **fine-cut CT C-spine through L-spine**; **CTA** to evaluate vertebral arteries in select cervical injuries.
...
- **AANS/CNS**: recommend MRI before **open reduction**, or before **closed reduction in unconscious/uncooperative**; if disc herniation → **anterior approach** for discectomy before reduction.

---

## Neurological Classification (ISNCSCI / ASIA)

- **ISNCSCI**: main outcome measure; do at **acute admission** as baseline.
- Summary scores include:
    - **ASIA motor score** (by key myotomes)
    - **ASIA sensory score**: light touch + pinprick across **28 dermatomes (C2–S4/S5)**
    - **ASIA Impairment Scale (AIS)** grade

### ASIA Impairment Scale (AIS) (core exam table)

|AIS grade|Definition (high-yield)|
|---|---|
|**A**|**Complete**: no sensory/motor below neuro level **including absent sacral function**|
|**B**|Sensory preserved (incl **S4–S5**) **without motor**; no motor >3 levels below|
|**C**|Motor preserved; **>50% key muscles <3/5**|
|**D**|Motor preserved; **>50% key muscles ≥3/5**|
|**E**|Normal neuro exam (prior deficits suspected SCI)|
...
|Syndrome|Typical context|Key findings|
|---|---|---|
|**Central cord**|Elderly + cervical spondylosis/stenosis; hyperextension fall|**UE weakness > LE**, + bladder dysfunction, variable sensory loss|
...
|Domain|Earlier target in 2017 review|2024 AO Spine/Praxis update|
|---|---|---|
