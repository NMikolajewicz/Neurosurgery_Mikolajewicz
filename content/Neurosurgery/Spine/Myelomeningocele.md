---
date created: Wednesday, September 6th 2023, 6:52:57 pm
date modified: Tuesday, February 17th 2026, 6:06:05 pm
tags: [myelomeningiocele, spinal-cord, spina-bifida, neurulation, chiari-malformation, neural-tube-defect]
---
...
```mermaid
flowchart TD
A["Newborn with open spinal defect"] --> B["Protect lesion<br/>Cover + avoid pressure"]
B --> C["Tx: start prophylactic antibiotics<br/>(nafcillin + gentamicin)"]
C --> D["Dx/Screen: head US + renal US + spine X-ray"]
D --> E["Tx: surgical closure within 24-48 h"]
E --> F["Monitor: OFC daily<br/>+ transfontanelle US for hydrocephalus"]
E --> G["Plan: neurogenic bladder catheterization<br/>+ ortho assessment"]
```
