...
* _Medical management with_ ==_methotrexate can be initiated in ectopic pregnancies_== _where_
	* _the size is less than 3.5 cm_
	* _the patient is hemodynamically stable,_
	* _there is no rupture_
	* _beta hCG levels are less than 5000 IU/L,_
	* _fetal heart rate is not detected_
	* _the patient does not suffer from renal, hepatic or hematological disease_
